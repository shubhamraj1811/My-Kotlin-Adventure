...
## #️⃣ The Core Idea
**[THE CORE IDEA - VIEW NOTES](CoreIdea.md)**

## #️⃣ First Example - CreateMyHuman
**[First OOP Code - VIEW NOTES](FirstOPPCode.md)**

## #️⃣ REAL WORLD APP - CHAICOFFEE
**[REAL WORLD APP - VIEW NOTES](RealWorldApplication.md)**

## #️⃣ CONSTRUCTORS
**[CONSTRUCTORS - VIEW NOTES](Constructor.md)**

## #️⃣ `init` BLOCK
**[init BLOCK - VIEW NOTES](INIT.md)**

## #️⃣ SECONDARY CONSTRUCTOR
**[SECONDARY CONSTRUCTOR - VIEW NOTES](SecondaryConstructor.md)**

## #️⃣ VISIBILITY MODIFIERS
**[VISIBILITY MODIFIERS - VIEW NOTES](VisibilityModifier.md)**
